...
TreeItem new2=new TreeItem("Jobs in India");
new2.getChildren().add(new TreeItem("Web DEveloper"));

new2.getChildren().add(new TreeItem("Front endDEveloper"));

new2.getChildren().add(new TreeItem("back DEveloper"));
new2.getChildren().add(new TreeItem("stack DEveloper"));
new2.getChildren().add(new TreeItem("software DEveloper"));
rootItem.getChildren().add(new2);
